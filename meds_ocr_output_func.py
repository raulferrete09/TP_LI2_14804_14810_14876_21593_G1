...
def ocrOut(img):
    ...
    all = False
    finalOutput = False
    outputs = all and True
    display = all and True  # Sobel
    display2 = all and False # Vertices
    display3 = all and True  # Transformation
    display4 = all and True  # OCR
    # transform
    aspectRatio = True
    ...
    threshImages = images
    threshold = 15  # todo 10-200 ---------------------------------------------------------------calibrar
    for i in range(len(images)):
...
if testing:
    img = cv2.imread(
        '/Users/diogo/Desktop/Cadeiras/Mestrado/labs II/scripts/Imagem/Meds/Images/paracetamol_from_net2.jpg',
        cv2.IMREAD_GRAYSCALE)

# print(ocrOut(img))u
# img=cv2.imread("FaceDir1/medicamento.jpg")
# dim = (720, 480)
